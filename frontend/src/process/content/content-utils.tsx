...
export function toHTML(markdown: any) {
  ...
  // Enable GitHub-flavored extensions: tables (so `| col | col |` markdown
  // renders as a real <table>), strikethrough, and tasklists. The
  // Battlezoo Refine / Imbue activity descriptions use real markdown
  // tables so the cost-per-level info reads as a table, not a wall of
  // bullets.
